...
contract TokenizedStrategy {
    ...
    function previewWithdraw(uint256 assets) public view returns (uint256) {
        ...
        return assets.mulDiv(_totalSupply, _totalAssets, Math.Rounding.Ceil);
    }
     ...
     */
    function _withdraw(address receiver, address owner, uint256 assets, uint256 shares, uint256 maxLoss)
        private
        returns (uint256)
    {
